            ...
            <div class="movie_menu">
				...
				<div class="hot_swtich">
                    <router-link to="/movie/nowPlaying" custom v-slot="{navigate,isActive,isExactActive}">
                        <div :class="[isActive&&'router-link-active',isExactActive &&'router-link-exact-active']" @click="navigate" role="link" class="hot_item">正在热映</div>
                    </router-link>
					<router-link to="/movie/comingSoon" custom v-slot="{navigate,isActive,isExactActive}">
                        <div :class="[isActive&&'router-link-active',isExactActive &&'router-link-exact-active']" @click="navigate" role="link" class="hot_item">即将上映</div>
                    </router-link>	
				</div>
